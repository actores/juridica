...
<div class="w-full">
    <!-- Icono / Logo superior derecho del panel -->
    <div class="absolute top-8 lg:top-12 right-8 lg:right-12">
        <div class="w-12 h-12 lg:w-14 lg:h-14 rounded-2xl shadow-sm overflow-hidden bg-white border border-gray-50 flex items-center justify-center p-2">
            <img src="https://usuarios.actores.tech/assets/img/logos/favicon.ico" class="w-full h-full object-contain">
        </div>
    </div>
    ...
    <div class="mb-8 lg:mb-14 flex items-center gap-3">
        ...
        <span class="text-[10px] font-black uppercase tracking-[0.4em] text-[#642D8E]">Área Legal</span>
    </div>

    <div class="mb-8 lg:mb-12">
        <h3 class="text-3xl lg:text-4xl font-black text-[#030712] uppercase tracking-tighter mb-3">Ingreso Portal</h3>
        <p class="text-[#6B7280] font-semibold text-sm leading-relaxed">
    ...
    <form wire:submit="login" class="space-y-6 lg:space-y-8 relative z-20">
        <!-- Correo -->
        <div class="relative">
            <label for="email" class="block text-[10px] font-black uppercase tracking-[0.3em] text-[#6B7280] mb-2">
                Correo Corporativo
            </label>
            <input wire:model="form.email" id="email" type="email" name="email" required autofocus
                placeholder="tucorreo@actores.org.co"
                class="w-full py-3 border-b border-gray-200 focus:border-[#642D8E] outline-none text-[#030712] font-bold transition-all bg-transparent placeholder:text-gray-300">
            <x-input-error :messages="$errors->get('form.email')" class="mt-2" />
        </div>

        <!-- Contraseña -->
        <div class="relative">
            <label for="password" class="block text-[10px] font-black uppercase tracking-[0.3em] text-[#6B7280] mb-2">
                Contraseña
            </label>
        ...
        <div class="flex items-center">
            <label for="remember" class="inline-flex items-center cursor-pointer group">
                ...
                <span class="ms-3 text-[11px] font-bold text-gray-400 group-hover:text-gray-600 uppercase tracking-widest transition-colors">Mantener sesión</span>
            </label>
        </div>
